...
?>
   ...
   <div class="tp-about-us-area pt-120 pb-120">
      <div class="container">
         <div class="row">
            <!-- left Content -->
            <div class="col-xl-10 col-lg-10 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
               <div class="">
                              ...
                              <div class="col-md-12 col-xl-12">
                                 ...
                                 <div class="card" style="border-radius: 15px;border-color:rgb(117 35 118);">
                                    <div class="card-body text-center">
                                       ...
                                       <p class="text-muted mb-4"><?php echo $_SESSION['address']; ?></p>
                                       <p class="text-muted mb-4"><?php echo $_SESSION['timestamp']; ?></p>
                                       <?php if (isset($_REQUEST['lgout'])) {
                                          session_destroy();
                                          header("location: https://pro6advies.samiulfaysal.com/");
                                       } ?>
                                       <form action="#">
...
<?php
   ...
   echo $msg;
   header("Refresh: 3; url=https://pro6advies.samiulfaysal.com/prive-inhoud/inloggen-registreren/");
}
