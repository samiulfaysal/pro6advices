...
?>
   ...
   <div class="tp-about-us-area pt-120 pb-120">
      <div class="container">
         <div class="row">
            <!-- left Content -->
            <div class="col-xl-10 col-lg-9 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
               <div class="">
                              ...
                              <div class="col-xl-4 col-lg-4 mb-30  wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                                 <div class="service-item-three text-center">
                                    <div class="service-item-three__img">
                                       <?php
                                       $image = $childs->single_image;
                                       if ($image) {
                                          $thumb = $image->size(1200, 800);
                                          echo "<img class=\"img-fluid service_img\"  src='$thumb->url' alt='$thumb->description'>";
                                       }
                                       ?>
                                    </div>
                                    <div class="service-item-three__content">
                                       <h4 class="tp-service-sm-title"><a href="service-details.html"><?php echo $childs->title; ?></a></h4>
                                       <p><?php echo $childs->bizcontent; ?></p>
                                    </div>
            ...
            <div class=" col-xl-3 col-lg-3 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".8s">
               <div class="tp-img-inner text-end">
                  <div class="row gx-3">
                     <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                        <!-- Profile Card -->
                        <div style="position: fixed;z-index:1; left: 90%;top: 42%;transform: translateX(-50%);" class=" ">
                           <div class="row d-flex justify-content-center align-items-center h-100 ">
                              <div class="col-md-12 col-xl-12">

                                 <div class="card" style="border-radius: 15px;border-color:rgb(117 35 118);">
                                    <div class="card-body text-center">
                                       <div class="mt-3 mb-4">
                                          <img src="<?php echo $config->urls->templates; ?>assets/img/logo/user-profile.svg"
                                             class=" img-fluid" />
                                       </div>
                                       <h4 class="mb-2"><?php echo $_SESSION['name']; ?></h4>
                                       <div class="text-muted "><?php echo $_SESSION['email']; ?></div>
                                       <div class="text-muted "><?php echo $_SESSION['address']; ?> </div>
                                       <div class="text-muted mb-1">
                                          <span><b>Joind since:</b><br></span>
                                          <?php 
                                          $t= strtotime($_SESSION['timestamp']);
                                          echo(date("jS \of F Y",$t));
                                          
                                          ?>
                                       </div>
                                       <?php if (isset($_REQUEST['lgout'])) {
                                          session_destroy();
                                          header("location:" . $pages->get(1)->httpUrl);
                                       } ?>
                                       <form action="#">
                                          <button type="submit" name="lgout" style="color:rgb(117 35 118);border-color:rgb(117 35 118);" class="btn btn-outline-primary btn-rounded btn-lg">
                                             Logout
                                          </button>
                                       </form>
                                    </div>
...
<?php
   ...
   $msg = "<h1 style=\" margin:200px 0px;\" class=\" text-center text-danger\">Unauthorised Access! You'll be redirect to Login page </h1>";
   echo $msg;
   $rg = $pages->get('/inloggen-registreren/')->httpUrl;
   header("Refresh: 3; url=" . "$rg");
}
