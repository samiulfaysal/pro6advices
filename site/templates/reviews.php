      ...
      <div class="row g-0 justify-content-center">
         <div class="col-xl-6">
            <div class="tp-case-title-box mb-60 text-center wow tpfadeUp" data-wow-duration=".7s"
               data-wow-delay=".5s">
               <h3 class="tp-section-subtitle">Getuigenis</h3>
               <h3 class="tp-section-title-sm">Vertrouwd door <br> klanten</h3>
            </div>
         </div>
      </div>
            ...
            foreach ($page->children() as $childs) { ?>
               <div class="tp-case-item text-center p-relative mb-30">
                  <div class="tp-case-item__thumb fix">
                     <a href="case-details.html"><img src="<?php echo $config->urls->templates; ?>assets/img/testimonial/rvws.png" alt=""></a>
                  </div>
                  <div class="tp-circle-text">
                     <a href="<?php echo $childs->url; ?>"><?php echo $childs->title; ?></a>
                  </div>
               </div>
            <?php } ?>
         </div>
